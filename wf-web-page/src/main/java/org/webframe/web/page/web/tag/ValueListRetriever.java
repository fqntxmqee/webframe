...
public class ValueListRetriever extends ConfigurableTag {
	...
	public int doEndTag() throws JspException {
		...
		ValueListInfo info = ValueListRequestUtil.buildValueListInfo((HttpServletRequest) pageContext.getRequest(),
			rootTag.getTableInfo().getId());
		...
		ValueListHandler vlh = (ValueListHandler) context.getBean(ValueListHandler.DEFAULT_SERVICE_NAME,
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("Focus settings was setted up. Focus property '"
						+ focusProperty
						+ "', focus value '"
						+ focusValue
						+ "'");
	...
	/**
	 * @param focusProperty The focusProperty set usually name of column used to be id in table.
	 */
	...
	/**
	 * @param focusValue The focusValue set value on which will be occured in the generated table.
	 */
