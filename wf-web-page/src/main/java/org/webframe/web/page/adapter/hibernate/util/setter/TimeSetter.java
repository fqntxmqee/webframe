 ...
 * @version $Id: codetemplates.xml,v 1.1 2009/09/07 08:48:12 Exp $ Create: 2011-6-25 下午02:00:09
 */
public class TimeSetter extends AbstractSetter {
	 ...
	 */
	private static final Log	LOGGER			= LogFactory.getLog(TimeSetter.class);
	...
	/**
	 * Set the format for parsing <code>Date</code> from string values of keys. Default is "HH:mm:ss"
	 * 
