 ...
 * <code>ResultSetDecorator</code>. Using this validator you can enable or disable putting objects
 * into the final ResultsSet, thus into your final valueList. <p> <li> <em>Using validators is
 * recommended in the case when you cannot do a filtering in database tier, otherwise validators may
 * greatly slow down a performance because it's done in JVM.</em> </li> </p>
 * 
...
public interface ObjectValidator {
	 ...
	 * @return true if the given object is accepted at the final valueList. false if the given object
	 *         is rejected from the final valueList.
	 */
	public boolean isAcceptable(Object objectToBeChecked);

	/**
	 * Adapter will set ValueListInfo before use. This interface allow you to "send" some additional
	 * date that could be helpfull in "acceptable process".
	 * 
	 * @param info
	 */
