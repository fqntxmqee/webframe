...
public interface ModulePluginDriver {
	 ...
	 * 例如：我们的模块插件驱动实现类org.webframe.test.TestModulePluginDriver， model
	 * Bean的位置org.webframe.test.Test，那么该实现类getEntityLocation()
	 * 方法应该返回"/org/webframe/test"或者"*"字符串；
	 * 
	 * @return
	...
	/**
	 * 获取model页面freemarker模板的路径，例如：我们的模块插件驱动实现类 org.webframe.test.TestModulePluginDriver， model
	 * freemarker模板的位置org/webframe/test/new.ftl，那么该实现类
	 * getViewTempletLocation()方法应该返回"/org/webframe"。
	 * 
	 * @return
